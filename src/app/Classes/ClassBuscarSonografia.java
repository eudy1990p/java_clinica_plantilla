 ...
 * @author Eudy
 */
public class ClassBuscarSonografia{
    ...
    private String[] idTipoSangre,idTipoSOnografia,idMedico,idHospital;
    ...
    public ClassBuscarSonografia(){
        mysql = new Mysql();
    }
    public ClassBuscarSonografia(conection.Mysql mysql){
       this.mysql =mysql;
    }
    ...
    public void llenarComboBoxTipoSonografia(javax.swing.JComboBox JCTipoSangre){
    ...
    public void crearBusqueda(String idPaciente,String nombre,String apellido,String cedula,String fechaNacimiento,String sexo,String email,String telefono,String provincia,String sector,String direccion,String numeroSeguro,String nombreSeguro,String idTipoSangre,String idSonografia,String referidoPor,String QueContenga,String condicionSonografia,String fechaSonografia,String estadoSonografia,String tipoSonografia,String Medico,String Hospital){
        String where = " ";
        boolean primer = true;
        ...
        if(!tipoSonografia.isEmpty()){
            if(primer){
                where  += " s.id_type_of_sonography = '"+tipoSonografia+"'  ";
                primer = false;
            }else{
                where  += " and ( s.id_type_of_sonography = '"+tipoSonografia+"' )  ";
            }
        }
        ...
        if(!fechaSonografia.isEmpty()){
            if(primer){
                where  += " date(s.when_it) = '"+fechaSonografia+"'  ";
                primer = false;
            }else{
                where  += " and ( date(s.when_it) = '"+fechaSonografia+"' )  ";
            }
        }
