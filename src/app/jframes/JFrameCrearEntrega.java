...
public class JFrameCrearEntrega extends javax.swing.JFrame {
     ...
     */
    public JFrameCrearEntrega() {
        initComponents();
       this.user.mostrarDatosTabla(jTable1,this.jLabel6);
      // this.jtable();
    }
    public JFrameCrearEntrega(conection.Mysql mysql) {
       initComponents();
        this.mysql = mysql;
   ...
   //   new JFrameCrearEntrega().setVisible(true);
  // }
