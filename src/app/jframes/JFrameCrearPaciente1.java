...
public class JFrameCrearPaciente1 extends javax.swing.JFrame {
     ...
     */
    public JFrameCrearPaciente1() {
        initComponents();
       this.user.mostrarDatosTabla(jTable1,this.jLabel6);
      // this.jtable();
    }
    public JFrameCrearPaciente1(conection.Mysql mysql) {
       initComponents();
        this.mysql = mysql;
   ...
   //   new JFrameCrearPaciente1().setVisible(true);
  // }
