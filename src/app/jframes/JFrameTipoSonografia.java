 ...
 */
package app.jframes;
import app.Classes.ClassTipoSonografia;
/**
 *
 * @author Eudy
 */
...
public class JFrameTipoSonografia extends javax.swing.JFrame {
     ...
     */
    public JFrameTipoSonografia() {
        initComponents();
       this.user.mostrarDatosTabla(jTable1,this.jLabel6);
      // this.jtable();
    }
    public JFrameTipoSonografia(conection.Mysql mysql) {
       initComponents();
        this.mysql = mysql;
    ...
    public void jtable(){
           ...
           String[] titulos = {"id","name_of_type_sonography"};
    ...
    private void initComponents() {
        ...
        setTitle("Administrar De Tipo de Sonografia");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Administrar Tipo De Sonografia");
        ...
        jLabel5.setText("Total de Tipo De Sonografia");

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel6.setText("4000");

        jLabel7.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel7.setText("Buscar Tipo De Sonografia");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel8.setText("Tipo De Sonografia");

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabel9.setText("Agregar Tipo De Sonografia");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
      ...
      if(this.user.getAgregar()){
       ...
       // String type_user = (String) this.jComboBox1.getSelectedItem();
        ...
        boolean respuesta = this.user.insert(this.jTextField1.getText());
        if(respuesta){
            this.user.mostrarDatosTabla(this.jTable1, this.jLabel6);
            //this.user.mostrarNuevoDatoTabla(this.jTable1, this.jLabel6);
            this.user.limpiarTexto(jTextField1);
        }
      }else{
           //JOptionPane.showMessageDialog(null, type_user);
            boolean respuesta = this.user.update(this.jTextField1.getText(),this.id);
            if(respuesta){
                this.user.mostrarDatosTabla(this.jTable1, this.jLabel6);
